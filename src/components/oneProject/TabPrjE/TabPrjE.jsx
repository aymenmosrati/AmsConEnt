                                                                                                        ...
                                                                                                        <tr key={rquest.id}>
                                                                                                            <td className="col-sm-2">
                                                                                                                {rquest.evaluation == null ? (
                                                                                                                    <span className="eva">Exclus(NA)</span>
                                                                                                                ) : (
                                                                                                                    <span className="eva">{rquest.evaluation}</span>
                                                                                                                )}

                                                                                                            </td>
                                                                                                            <td className="col-sm-5">
                                                                                                                <span id="observation" className="obs" rows="2" cols="27"  >{rquest.observation}</span>

                                                                                                            </td>

                                                                                                            <td className="col-sm-1 note_">
                                                                                                                {rquest.note == null || rquest.evaluation == "Exclus(NA)" ? (
                                                                                                                    <b>NA</b>
                                                                                                                ) : (
                                                                                                                    <b>{rquest.note} %</b>
                                                                                                                )}
